...
IplImage* erosion_binary(IplImage* img)
{
	...
	cvNamedWindow("Erosion_Binary", CV_WINDOW_AUTOSIZE);
	cvShowImage("Erosion_Binary", filtered);
	cvSaveImage("Erosion_Binary.bmp", filtered);
	printf("\n Saved Successfully \n\n");
